...
public class RobotContainer {
    ...
    /* Controllers */
    private final static Joystick driver = new Joystick(0); //Logitech XboxController
    ...
    /* Drive Controls */
    private final static int translationAxis = XboxController.Axis.kLeftY.value;
    private final static int strafeAxis = XboxController.Axis.kLeftX.value;
    ...
    */
    ...
    private final JoystickButton mode1 = new JoystickButton(driver, 6);
    /*
    //INTAKE
    ...
    */
    ...
    public RobotContainer() {
        ...
        s_Swerve.setDefaultCommand(
            new TeleopSwerve(
                s_Swerve, 
                () -> Robot.getTranslationSpeed(), //smoother deccelaration
                () -> Robot.getStrafeSpeed(), //smoother deccelaration
...
*/
        ...
        */
        ...
        mode1.onTrue(new InstantCommand(() -> s_Swerve.mode1()));
        mode1.onFalse(new InstantCommand(() -> s_Swerve.mode0()));
